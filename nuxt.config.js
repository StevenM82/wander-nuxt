  ...
  head: {
    ...
    link: [
      { rel: 'stylesheet', type: 'text/css', href: 'https://fonts.googleapis.com/css?family=Nothing+You+Could+Do' },
      {
        ...
        //Search engines see every unique URL as a separate page. Search crawlers see this as 3 different pages: http://www.example.com, https://www.example.com, http://example.com
        hid: 'canonical',
        rel: 'canonical',
